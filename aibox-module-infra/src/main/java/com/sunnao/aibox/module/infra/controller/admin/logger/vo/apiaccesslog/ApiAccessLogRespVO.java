package com.sunnao.aibox.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.sunnao.aibox.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
