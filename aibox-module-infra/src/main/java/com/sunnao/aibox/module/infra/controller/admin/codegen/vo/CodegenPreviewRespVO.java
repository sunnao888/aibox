...
public class CodegenPreviewRespVO {
    ...
    @Schema(description = "文件路径", requiredMode = Schema.RequiredMode.REQUIRED, example = "java/com.sunnao.aibox/adminserver/modules/system/controller/test/SysTestDemoController.java")
