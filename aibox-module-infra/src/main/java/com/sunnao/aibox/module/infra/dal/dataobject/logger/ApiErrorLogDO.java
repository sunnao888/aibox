package com.sunnao.aibox.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 com.sunnao.aibox.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
