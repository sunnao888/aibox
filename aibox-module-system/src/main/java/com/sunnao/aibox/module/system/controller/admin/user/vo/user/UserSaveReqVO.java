package com.sunnao.aibox.module.system.controller.admin.user.vo.user;

import cn.hutool.core.util.ObjectUtil;
import com.fasterxml.jackson.annotation.JsonIgnore;
import com.mzt.logapi.starter.annotation.DiffLogField;
import com.sunnao.aibox.framework.common.validation.Mobile;
import com.sunnao.aibox.module.system.framework.operatelog.core.DeptParseFunction;
import com.sunnao.aibox.module.system.framework.operatelog.core.PostParseFunction;
import com.sunnao.aibox.module.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "aibox")
    ...
    @Schema(description = "用户邮箱", example = "aibox@iocoder.cn")
