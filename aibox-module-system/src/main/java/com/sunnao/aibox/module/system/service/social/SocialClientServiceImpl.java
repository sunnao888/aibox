...
import com.sunnao.aibox.framework.common.util.cache.CacheUtils;
...
import com.sunnao.aibox.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.sunnao.aibox.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.sunnao.aibox.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
import com.sunnao.aibox.module.system.dal.mysql.social.SocialClientMapper;
...
import com.sunnao.aibox.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.sunnao.aibox.framework.common.util.collection.MapUtils.findAndThen;
import static com.sunnao.aibox.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.sunnao.aibox.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${aibox.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${aibox.wxa-subscribe-message.miniprogram-state:formal}")
