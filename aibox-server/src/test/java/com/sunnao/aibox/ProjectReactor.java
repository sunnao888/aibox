...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.sunnao";
    private static final String ARTIFACT_ID = "aibox";
    private static final String PACKAGE_NAME = "com.sunnao.aibox";
    private static final String TITLE = "AIBox";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.sunnao";
        String artifactIdNew = "aibox";
        String packageNameNew = "com.sunnao.aibox";
        String titleNew = "AIBox";
