...
import com.sunnao.aibox.framework.tracer.core.aop.BizTraceAspect;
import com.sunnao.aibox.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "aibox.tracer", value = "enable", matchIfMissing = true)
public class OpenOjTracerAutoConfiguration {
