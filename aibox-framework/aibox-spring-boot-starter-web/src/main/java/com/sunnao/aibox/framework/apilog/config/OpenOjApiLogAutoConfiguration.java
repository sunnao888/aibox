...
import com.sunnao.aibox.framework.web.config.OpenOjWebAutoConfiguration;
...
@AutoConfiguration(after = OpenOjWebAutoConfiguration.class)
public class OpenOjApiLogAutoConfiguration implements WebMvcConfigurer {
