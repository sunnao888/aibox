package com.sunnao.aibox.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${aibox.websocket.sender-rocketmq.topic}",
        consumerGroup = "${aibox.websocket.sender-rocketmq.consumer-group}",
